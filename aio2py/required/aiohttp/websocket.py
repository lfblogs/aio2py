...
from aio2py.required.aiohttp import errors, hdrs
from aio2py.required.aiohttp.log import ws_logger
...
if bool(os.environ.get('AIOHTTP_NO_EXTENSIONS')):
    ...
    try:
        from aio2py.require.aiohttp._websocket import _websocket_mask_cython
